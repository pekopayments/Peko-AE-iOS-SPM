//
//  SelectDateRangeViewController.swift
//  Peko
//
//  Created by Hardik Makwana on 01/10/24.
//
...
public class SelectDateRangeViewController: UIViewController {

    @IBOutlet weak var startDateLabel: PekoLabel!
    @IBOutlet weak var endDateLabel: PekoLabel!
 ...
 //   public var delegate: HotelBookingSelectDatesViewControllerDelegate!
    ...
    {
        didSet{
          //  self.startDateLabel.text = selectedStartDate?.formate(format: "dd MMMM, yyyy")
        }
    }
        ...
        didSet{
            ...
            if selectedEndDate == nil {
                if selectedStartDate == nil {
                    self.startDateLabel.text = "Please select start & end dates"
                }else{
                    let str1 = (selectedStartDate?.formate(format: "dd MMMM, yyyy"))!
                    self.startDateLabel.text = str1 + " to " + str1
                }
            }else{
                let str1 = (selectedStartDate?.formate(format: "dd MMMM, yyyy"))!
                
                let str2 = (selectedEndDate?.formate(format: "dd MMMM, yyyy"))!
                
                self.startDateLabel.text = str1 + " to " + str2
            }
           
            // (selectedEndDate?.formate(format: "dd MMMM, yyyy"))
        }
    }
    public var preSelectedStartDate:Date?
    public var preSelectedEndDate:Date?
  ...
  //  public var titleText = "Select Dates"
    ...
    public var completionBlock:((_ startDate: Date,_ endDate: Date) -> Void)?
    
    
    public static func storyboardInstance() -> SelectDateRangeViewController? {
        return UIStoryboard(name: "Common", bundle: .module).instantiateViewController(identifier: "SelectDateRangeViewController") as? SelectDateRangeViewController
    }
...
//        self.isBackNavigationBarView = true
     //   self.setTitle(title: "Select Check-In & Check-Out Date")
        ...
        if self.preSelectedStartDate != nil {
            self.selectedStartDate = self.preSelectedStartDate
        }
        if self.preSelectedEndDate != nil {
            self.selectedEndDate = self.preSelectedEndDate
        }
        ...
        if minimumDate == nil {
            minimumDate = Date().addYears(years: -5)
        }
        if maximumDate == nil {
            maximumDate = Date() //Calendar.current.date(byAdding: .year, value: 3, to: minimumDate)
        }
    ...
    @IBAction func doneButtonClick(_ sender: Any) {
        ...
        if selectedStartDate != nil && selectedEndDate == nil {
            self.selectedEndDate = selectedStartDate
...
extension SelectDateRangeViewController:UICollectionViewDataSource, UICollectionViewDelegate {
...
extension SelectDateRangeViewController : UICollectionViewDelegateFlowLayout {
...
extension SelectDateRangeViewController {
