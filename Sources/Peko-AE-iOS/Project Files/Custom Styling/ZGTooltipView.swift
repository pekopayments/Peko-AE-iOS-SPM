...
open class ZGTooltipView: UIView {
    ...
    fileprivate static func createLabel(text: String) -> UILabel {
        ...
        label.addConstraint(NSLayoutConstraint(item: label, attribute: .width, relatedBy: .lessThanOrEqual, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: UIScreen.main.bounds.width * 0.6))
